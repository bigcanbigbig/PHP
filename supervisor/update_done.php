...
<body>
	<div class="wrapper">
		...
		<div class="header2nd_found">
			...
			<a href="done.php"><div class="button_done_s">
				<h2>已領</h2>
			</div></a>
		</div>
		<div class="content_found">
			...
			<div class="content_take">
				<?php
					...
					echo "<form action='updateresult_done.php' method='post' enctype='multipart/form-data'>";
					...
					echo "領取人:<input type='text' name='TakePerson' value='".$result[7]."'><br/>";
					echo "領取人電話:<input type='text' name='TakePhone' value='".$result[8]."'><br/>";

					echo "<input type='submit' value='更新'>
					&nbsp;
					<input type='reset' value='重填'>
					&nbsp;";
					echo '<input type="button" value="修改圖片" onclick="location.href=\'updatepic_done.php?no='.$result[0].'\'">&nbsp;&nbsp;';
					echo '<input type="button" value="取消" onclick="location.href=\'done.php\'">';
					echo "</p>";
					echo "</div>";
